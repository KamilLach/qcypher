...
function QCypher() {
  ...
  function transCreate() {
    ...
    function createTransactionUrl(commitId) {
        return graphDatabaseUrl + '/db/data/transaction/' + commitId
    }

    function parseTransactionId(transactionUrl){
        var regex = /db\/data\/transaction\/(.*)/;
        var match = regex.exec(transactionUrl);
    ...
    try {
      ...
      qrequest({
        ...
        .then(function resolved(result) {
              transObject.commitUrl = createTransactionUrl(parseTransactionId(result.commit));
